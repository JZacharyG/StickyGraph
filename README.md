...
Be warned, some graph input/output formats (like graph6) only make sense for simple graphs, so while in multigraph mode, they will encode the underlying simple graph.
